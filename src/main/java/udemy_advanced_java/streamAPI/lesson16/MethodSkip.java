package udemy_advanced_java.streamAPI.lesson16;
...
public class MethodSkip {
    public static void main(String[] args) {
        ...
        students.stream().filter(e -> e.getAge() > 20).forEach(System.out::println); // => выводит в строку всех студентов больше 20 лет
        System.out.println("---------------------------------------------------------");
        ...
        System.out.println("---------------------------------------------------------");
        students.stream().filter(e -> e.getAge() > 20).skip(3).forEach(System.out::println); // => Student{name='Mariya', sex=f, age=23, course=3, avgGrade=7.4}
    }
}
